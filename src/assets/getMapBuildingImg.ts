...
const MAGE_TOWER_VARIANTS: Record<string, [string, string]> = {
  ...
  [`${HeroUnitName.CLERIC}|${HeroUnitName.DRUID}|${HeroUnitName.ENCHANTER}`]: [
    `${KEY_PREFIX}mage-tower-white-green-blue`,
    mageTowerWhiteGreenBlueImg,
  ],
  [`${HeroUnitName.DRUID}|${HeroUnitName.ENCHANTER}|${HeroUnitName.PYROMANCER}`]: [
    `${KEY_PREFIX}mage-tower-green-blue-red`,
    mageTowerGreenBlueRedImg,
  ],
  [`${HeroUnitName.ENCHANTER}|${HeroUnitName.NECROMANCER}|${HeroUnitName.PYROMANCER}`]: [
    `${KEY_PREFIX}mage-tower-blue-red-black`,
    mageTowerBlueRedBlackImg,
  ],
