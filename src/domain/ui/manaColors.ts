 ...
 * @param mana - The mana type to get color for
 * @returns Hex color string for the mana type
 */
 ...
 * @param mana - The mana type to get gradient for
 * @returns Tuple of [base color, darker color] for gradients
 */
