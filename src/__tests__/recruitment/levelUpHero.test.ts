...
describe('level up hero', () => {
  it.each([
    [
      ...
      { attack: 34, defense: 3, range: 2, rangeDamage: 34, speed: 5, mana: undefined },
    ],
    [
    ...
    [
      ...
      9,
      PREDEFINED_PLAYERS[0],
      { attack: 52, defense: 6, range: 2, rangeDamage: 52, speed: 5, mana: undefined },
    ],
    [
      HeroUnitName.NECROMANCER,
      9,
      PREDEFINED_PLAYERS[1],
      { attack: 38, defense: 5, range: 25, rangeDamage: 48, speed: 3, mana: 5 },
    ],
    [
      HeroUnitName.FIGHTER,
      31,
      PREDEFINED_PLAYERS[0],
      { attack: 128, defense: 18, range: 2, rangeDamage: 128, speed: 5, mana: undefined },
    ],
    [
      HeroUnitName.NECROMANCER,
      31,
      PREDEFINED_PLAYERS[1],
      { attack: 51, defense: 15, range: 25, rangeDamage: 93, speed: 3, mana: 20 },
    ],
    [
    ...
    [
      ...
      { attack: 106, defense: 18, range: 2, rangeDamage: 106, speed: 3, mana: 20 },
    ],
    [
      HeroUnitName.DRUID,
      31,
      PREDEFINED_PLAYERS[12],
      { attack: 101, defense: 17, range: 2, rangeDamage: 101, speed: 4, mana: 20 },
    ],
    [
      HeroUnitName.PYROMANCER,
      31,
      PREDEFINED_PLAYERS[14],
      { attack: 46, defense: 16, range: 30, rangeDamage: 88, speed: 3, mana: 20 },
    ],
  ])(
